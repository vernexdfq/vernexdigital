  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] pb-28">
      ...
      <div className="px-4 pt-4 space-y-4">
        ...
        {/* More Services - Auto Renew only */}
        <div className="rounded-[14px] bg-white border border-[#E2E8F0] p-4">
          <h2 className="text-sm font-semibold text-[#0F172A] mb-3">More Services</h2>
          <button
            type="button"
            className="w-full flex items-center gap-3 p-3 rounded-[12px] bg-[#F8FAFC] border border-[#E2E8F0] text-left"
          >
            ...
            <div className="mt-4 rounded-[14px] bg-[#F8FAFC] border border-[#E2E8F0] p-4 space-y-3">
              <div className="flex justify-between text-sm">
                ...
                <span className="font-medium text-[#0F172A] flex items-center gap-1.5">
                  {activeNetwork && <NetworkBadge networkId={activeNetwork.id} size="sm" />}
                  {activeNetwork?.name}
                </span>
              </div>
              <div className="flex justify-between text-sm">
