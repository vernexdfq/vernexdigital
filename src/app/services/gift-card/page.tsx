              ...
              {filteredOrders.map((o) => (
                <div key={o.id} className="bg-white rounded-[12px] border border-[#E2E8F0] p-4 flex items-center justify-between">
                  ...
                  <div className="text-right">
                    ...
                    <p className={`text-[10px] font-semibold ${o.status === "SUCCESS" ? "text-green-600" : o.status === "REJECTED" ? "text-red-500" : "text-amber-500"}`}>{o.status}</p>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="space-y-3">
              {savedBanks.map((b, i) => (
                <div key={i} className="bg-white rounded-[12px] border border-[#E2E8F0] p-4">
                  ...
                  <p className="text-[13px] text-[#64748B]">{b.acct}</p>
                  <p className="text-[12px] text-[#94A3B8]">{b.name}</p>
                </div>
              ))}
